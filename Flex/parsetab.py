...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','AppClass.py',67),
  ('statement -> expression','statement',1,'p_statement_expr','AppClass.py',72),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','AppClass.py',77),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','AppClass.py',78),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','AppClass.py',79),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','AppClass.py',80),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','AppClass.py',92),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','AppClass.py',97),
  ('expression -> NUMBER','expression',1,'p_expression_number','AppClass.py',102),
  ('expression -> NAME','expression',1,'p_expression_name','AppClass.py',107),
]
